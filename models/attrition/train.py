"""
Trains the attrition model on Databricks, logs to MLflow, registers to
Unity Catalog, and promotes to @champion only if it beats the current
champion's test ROC-AUC (or if there is no champion yet).
...
# --- train + log --------------------------------------------------------
with mlflow.start_run(run_name="attrition_training") as run:
